...
*/
--drop perge artık kurtarılamayacak şekilde siler
CREATE TABLE parent
(
...
delete from parent where vergi_no=101;-- Key (vergi_no)=(101) is still referenced from table "child".
...
delete from parent where vergi_no=101;--child table'dan sildigimiz icin parent tablosunda da silebilirz.
select * from parent;
...
--child tabloyu sildigimiz icin artik 
--parent tabloyu da silebiliri.
drop table parent;
...
--ON DELETE CASCADE sayesinde.child tablodaki veriler de silindi
delete from parent2;
select * from parent2;
